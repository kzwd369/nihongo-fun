...
jlpt: N4
metaDescription: >-
  日語「ハンドル」（handoru）指的是方向盤或車把，但英語的「handle」是門把或把手，絕對不是開車時握的那個圓盤。
...
這裡就危險了。英語動詞 **to handle** 表示處理、控制、應付某事。所以「she handles the car well」意思是她**開車技術高超**——是在誇獎整體駕駛技巧，而不是在描述她握著方向盤的動作。
