...
romaji: purin
jlpt: N4
metaDescription: 日語的「プリン」不是泛指布丁，而是特指焦糖布丁！了解這個和製英語如何縮小到一種甜點。
category: food
tags: ['食物', '甜點', '日常生活']
draft: false
...
examples:
  - japanese: プリンを作るのは意外と簡単だよ。
    ...
    translation: 做布丁其實出乎意料地簡單。
  - japanese: コンビニのプリンが最近すごくおいしくなった。
    reading: コンビニの プリンが さいきん すごく おいしく なった。
    translation: 便利商店的布丁最近變得超好吃。
  - japanese: 子供の頃、おやつはいつもプリンだった。
    reading: こどもの ころ、おやつは いつも プリンだった。
    translation: 小時候，點心總是布丁。
animeAppearances:
  - title: 銀魂（Gintama）
    description: 坂田銀時出了名地愛吃プリン。他對焦糖布丁的熱愛是經典橋段——他會為了冰箱裡最後一個布丁而打架，還會在上面寫自己的名字來宣示主權。
  - title: 航海王（One Piece）
    description: 大媽對甜食的瘋狂當然包括プリン——而且她的第35個女兒就叫 Pudding（プリン）。夏洛特家族以甜點命名的傳統，凸顯了甜食在這個篇章中的重要地位。
