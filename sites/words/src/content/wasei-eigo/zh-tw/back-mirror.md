...
jlpt: N3
metaDescription: >-
  日語「バックミラー」（bakku mirā）指的是駕駛用來確認後方的鏡子，但英語母語者只會說「rearview mirror」或「side mirror」，從不說「back mirror」。
category: transportation
tags: ['交通', '日常生活', '駕駛']
draft: false
publishedAt: '2026-04-22'
originalEnglish: back mirror
japaneseMeaning: 汽車後照鏡／側後視鏡
englishMeaning: 後照鏡（rearview mirror / side mirror / wing mirror）
examples:
  - japanese: バックミラーで後ろを確認する。
    reading: バックミラーで うしろを かくにんする。
    translation: 用後照鏡確認後方。
  - japanese: バックミラーに大きなトラックが見えた。
    reading: バックミラーに おおきな トラックが みえた。
    translation: 後照鏡裡看到一台大卡車。
  - japanese: サイドのバックミラーを調整してください。
    reading: サイドの バックミラーを ちょうせいしてください。
    translation: 請調整一下側後視鏡。
animeAppearances:
  - title: 頭文字D（頭文字D）
    description: >-
...
在日語中，**バック** 只要是在車的語境裡，就漂移成「後方」或「反方向」的意思。英語則會依照對象把這拆成 **rear**、**back**、**reverse**、**backup** 等不同詞。英語母語者聽到停車時有人說「please do a back」，大概會以為駕駛剛剛中風。但在日語裡，**バックして** 是再正常不過、合乎文法的「請倒車」。
...
日本駕訓班有一句變換車道的口訣：**ミラー・ウィンカー・目視**（**mirā, winkā, mokushi**）——「鏡子、方向燈、目視確認」。這串口訣裡每一個字都是翻譯地雷。**ミラー** 就是統稱式的 back mirror；**ウィンカー**（**winker**）則是和製英語的方向燈，真正的英語叫 **blinker** 或 **indicator**；只有 **目視**（目視確認）是純正日語。才說三個詞，學員就已經用了兩個會讓英語母語教練一頭霧水的和製英語——而車子甚至還沒開出停車場呢。
