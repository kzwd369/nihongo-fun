...
jlpt: N4
metaDescription: >-
  日語「シャープペンシル」（shāpu penshiru）就是自動鉛筆，也正是 Sharp（夏普）公司名稱的由來！一支筆命名了一間科技巨擘。
category: stationery
tags: ['文具', '學校', '日常生活']
draft: false
...
examples:
  - japanese: シャープペンシルの芯が折れた。
    ...
    translation: 自動鉛筆的筆芯斷了。
  - japanese: 試験ではシャーペンを使ってもいいですか。
    reading: しけんでは シャーペンを つかっても いいですか。
    translation: 考試可以用自動鉛筆嗎？
  - japanese: 0.5ミリのシャーペンが一番書きやすい。
    reading: れいてんごミリの シャーペンが いちばん かきやすい。
    translation: 0.5 公釐的自動鉛筆最好寫。
animeAppearances:
  - title: 爆漫王。（Bakuman）
    description: 漫畫家最高和秋人以 シャープペンシル 繪製分鏡和台詞草稿，呈現出這項工具在日本漫畫製作流程中的核心地位。
  - title: 冰菓（Hyouka）
    description: 古籍研究社的調查場景裡充滿 シャーペン 在紙上沙沙作響的聲音，折木和千反田翻閱線索和舊文件的身影歷歷在目。
