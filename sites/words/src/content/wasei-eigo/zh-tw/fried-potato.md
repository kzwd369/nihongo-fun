...
jlpt: N4
metaDescription: >-
  日語「フライドポテト」（furaido poteto）就是薯條。快來看看為什麼日本為這款全球聞名的點心，造出了自己直白的說法！
category: food
tags: ['食物', '速食', '日常生活']
draft: false
...
examples:
  - japanese: マックでフライドポテトのLサイズを頼んだ。
    ...
    translation: 在麥當勞點了大薯。
  - japanese: ビールにはフライドポテトがよく合う。
    reading: ビールには フライドポテトが よく あう。
    translation: 薯條跟啤酒超搭的。
  - japanese: 子供たちはフライドポテトが大好きだ。
    reading: こどもたちは フライドポテトが だいすきだ。
    translation: 小孩們最愛吃薯條。
animeAppearances:
  - title: 輕音部（K-On!）
    description: 輕音部的女生們經常在練習結束後的家庭餐廳分食一盤 フライドポテト，是非常日本高中生的點心時光。
  - title: 蠟筆小新（Crayon Shin-chan）
    description: 野原新之助對速食的癡迷，讓 フライドポテト 頻繁出現在一家人光顧麥當勞類連鎖店的場景中。
...
來日本的英語母語者常常覺得好笑：每一份菜單上都寫著「fried potato」。這個詞在英語裡確實存在，但聽起來像是在描述做法，不像菜名。在日語裡，這就是*它的名字*。
