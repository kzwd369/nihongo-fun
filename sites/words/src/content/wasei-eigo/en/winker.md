...
jlpt: N3
metaDescription: >-
  Japanese "ウィンカー" (winkā) means a car's turn signal — but native English speakers say "turn signal" (US), "blinker" (US), or "indicator" (UK). "Winker" is not the normal English word for it.
...
examples:
  - japanese: 右折するのでウィンカーを出した。
    ...
    translation: I turned on my turn signal because I was turning right.
  - japanese: ウィンカーを出さずに曲がるのは違反だ。
    reading: ウィンカーを ださずに まがるのは いはんだ。
    translation: Turning without signaling is a traffic violation.
  - japanese: ウィンカーが点かない。
    reading: ウィンカーが つかない。
    translation: The turn signal isn't working.
animeAppearances:
