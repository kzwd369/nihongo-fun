...
jlpt: N3
metaDescription: >-
  Japanese "コストダウン" (kosuto daun) means cost reduction — but native English speakers say "cost cutting" or "reduce costs," never "cost down" as a noun.
category: business
...
examples:
  - japanese: 工場のコストダウンを進めている。
    ...
    translation: We're working on cost reduction at the factory.
  - japanese: 部品を変えてコストダウンに成功した。
    reading: ぶひんを かえて コストダウンに せいこうした。
    translation: We changed the parts and succeeded in cutting costs.
  - japanese: 品質を下げずにコストダウンするのは難しい。
    reading: ひんしつを さげずに コストダウンするのは むずかしい。
    translation: It's hard to cut costs without lowering quality.
animeAppearances:
  - title: Shin Godzilla (シン・ゴジラ)
    description: Government meeting scenes constantly invoke コストダウン as bureaucrats debate emergency-response budget constraints. The film lovingly parodies real Japanese ministerial jargon, and the word lands as both bureaucratic tic and gallows humor.
  - title: Aggretsuko (アグレッシブ烈子)
    description: Retsuko's accounting office is constantly under pressure for コストダウン from upper management. The relentless demand to squeeze the budget is exactly the kind of corporate grind that fuels her after-hours death-metal karaoke catharsis.
