...
jlpt: N2
metaDescription: >-
  Japanese "ワンパターン" (wan patān) doesn't mean anything in English — "one pattern" is not an idiom. Native English says "predictable", "formulaic", "cookie-cutter", or "a one-trick pony".
category: slang
tags: ['slang', 'idiom', 'behavior']
draft: false
publishedAt: '2026-04-22'
originalEnglish: one pattern
japaneseMeaning: Predictable / repetitive / formulaic / a one-trick pony
englishMeaning: Predictable / formulaic / cookie-cutter / repetitive
examples:
  - japanese: 彼のギャグはワンパターンだ。
    reading: かれの ギャグは ワンパターンだ。
    translation: His jokes are so predictable — always the same setup.
  - japanese: 最近のトレンディドラマはワンパターンすぎる。
    reading: さいきんの トレンディ ドラマは ワンパターン すぎる。
    translation: Recent trendy dramas are way too formulaic.
  - japanese: デートがワンパターンで彼女に飽きられた。
    reading: デートが ワンパターンで かのじょに あきられた。
    translation: My dates were so cookie-cutter that my girlfriend got bored of me.
animeAppearances:
