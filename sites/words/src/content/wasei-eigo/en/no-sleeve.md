...
jlpt: N3
metaDescription: >-
  Japanese "ノースリーブ" (nōsurību) means sleeveless. Learn why Japanese fashion coined a "no-" prefix word that English speakers never use.
category: fashion
...
examples:
  - japanese: 夏はノースリーブの服が楽だ。
    ...
    translation: Sleeveless clothes are really comfortable in summer.
  - japanese: ノースリーブのワンピースを買った。
    reading: ノースリーブの ワンピースを かった。
    translation: I bought a sleeveless dress.
  - japanese: オフィスではノースリーブは控えたほうがいい。
    reading: オフィスでは ノースリーブは ひかえた ほうが いい。
    translation: It's better to avoid sleeveless at the office.
animeAppearances:
  - title: Fairy Tail
    description: Many of the guild's female fighters — Erza Scarlet, Lucy, Cana — wear ノースリーブ tops as their everyday battle wear, fitting the series' adventurous aesthetic.
  - title: My Teen Romantic Comedy SNAFU (Oregairu)
    description: Summer episodes show classmates shifting into ノースリーブ outfits, turning a simple wardrobe change into a seasonal visual cue the show uses to mark time passing.
