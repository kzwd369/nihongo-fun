...
jlpt: N4
metaDescription: >-
  Japanese "トレーナー" (torēnā) means a sweatshirt, not a sneaker or a coach. Learn how "trainer" migrated from athletic wear to casual wardrobe staple.
category: fashion
...
examples:
  - japanese: 寒くなってきたのでトレーナーを着た。
    ...
    translation: It's been getting cold, so I put on a sweatshirt.
  - japanese: このグレーのトレーナー、気に入ってる。
    reading: この グレーの トレーナー、きに いってる。
    translation: I really like this gray sweatshirt.
  - japanese: 寒い日はトレーナーの上にパーカーを重ねる。
    reading: さむい ひは トレーナーの うえに パーカーを かさねる。
    translation: On cold days, I layer a hoodie over a sweatshirt.
animeAppearances:
  - title: Haikyuu!!
    description: Off-court scenes show the Karasuno volleyball club wearing casual トレーナー as everyday school-life wear when they're not in uniform, reflecting real Japanese student fashion.
  - title: Himouto! Umaru-chan
    description: Umaru's iconic indoor persona is triggered by her putting on a hooded トレーナー — the series makes the garment a visual shorthand for her "at home" identity.
