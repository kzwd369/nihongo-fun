...
jlpt: N4
metaDescription: >-
  Japanese "マフラー" (mafurā) means a winter scarf — not a car part. Learn how this word's meaning split between two languages, and why a red マフラー breaks hearts in anime.
category: fashion
...
examples:
  - japanese: 寒いのでマフラーを巻いた。
    ...
    translation: It was cold, so I wrapped a scarf around my neck.
  - japanese: 手編みのマフラーをプレゼントした。
    reading: てあみの マフラーを プレゼントした。
    translation: I gave a handmade scarf as a gift.
  - japanese: 赤いマフラーがよく似合うね。
    reading: あかい マフラーが よく にあうね。
    translation: That red scarf really suits you.
animeAppearances:
  - title: Attack on Titan (Shingeki no Kyojin)
    description: Mikasa Ackerman's red マフラー, given to her by Eren when they first meet, is one of the most iconic items in modern anime — a symbol of safety, belonging, and her entire emotional anchor to Eren.
  - title: Your Name (Kimi no Na wa)
    description: The red マフラー that Mitsuha leaves for Taki becomes one of the film's key objects, carrying memory and connection across time and space.
