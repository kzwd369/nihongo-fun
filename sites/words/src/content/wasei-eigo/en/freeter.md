...
jlpt: N2
metaDescription: >-
  "フリーター" (freeter) blends English "free" and German "Arbeiter" — a Japanese-only word for young part-time job hoppers.
category: work
tags: ['work', 'culture', 'society']
draft: false
publishedAt: '2026-04-13'
originalEnglish: free + Arbeiter
japaneseMeaning: A person who moves between part-time jobs without pursuing a career (typically young adults)
englishMeaning: A young part-time worker without a fixed career path
examples:
  - japanese: 大学を卒業してからずっとフリーターをしている。
    reading: だいがくを そつぎょうしてから ずっと フリーターを している。
    translation: I've been a freeter ever since graduating from university.
  - japanese: フリーターから正社員になるのは難しい。
    reading: フリーターから せいしゃいんに なるのは むずかしい。
    translation: It's hard to go from being a freeter to a full-time employee.
  - japanese: 息子がフリーターで将来が心配だ。
    reading: むすこが フリーターで しょうらいが しんぱいだ。
    translation: My son is a freeter, and I'm worried about his future.
animeAppearances:
  - title: Welcome to the NHK
    description: The protagonist Satou is surrounded by characters living on society's margins. The freeter lifestyle is closely tied to the show's exploration of hikikomori, NEET culture, and the pressure of Japanese employment norms.
  - title: The Devil is a Part-Timer! (Hataraku Maou-sama!)
    description: The Dark Lord Satan himself becomes essentially a freeter in modern Tokyo, working at a fast food restaurant. The comedy comes from a demon king taking part-time work seriously — a playful take on freeter life.
