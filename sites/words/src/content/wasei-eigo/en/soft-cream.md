...
jlpt: N5
metaDescription: >-
  Japanese "ソフトクリーム" (sofuto kurīmu) means soft-serve ice cream. Learn how Japan turned a simple imported treat into a regional flavor obsession.
category: food
tags: ['food', 'dessert', 'daily-life']
draft: false
...
examples:
  - japanese: 夏は毎日ソフトクリームが食べたくなる。
    ...
    translation: In summer, I want to eat soft-serve every single day.
  - japanese: 北海道のソフトクリームは格別だ。
    reading: ほっかいどうの ソフトクリームは かくべつだ。
    translation: Hokkaido soft-serve is something else.
  - japanese: 抹茶とバニラのミックスソフトクリームをください。
    reading: まっちゃと バニラの ミックスソフトクリームを ください。
    translation: I'd like a matcha-and-vanilla mix soft-serve, please.
animeAppearances:
  - title: Yuru Camp (Laid-Back Camp)
    description: The girls frequently stop at rest areas and roadside stations on their camping trips, and a ソフトクリーム in hand is practically a visual motif of the series.
  - title: Non Non Biyori
    description: The rural schoolchildren treat a ソフトクリーム from the local shop as a major event, capturing how the Japanese countryside turns small treats into big moments.
