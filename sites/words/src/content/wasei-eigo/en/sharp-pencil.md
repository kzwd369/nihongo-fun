...
jlpt: N4
metaDescription: >-
  Japanese "シャープペンシル" (shāpu penshiru) means mechanical pencil — and it's the reason Sharp Corporation is called Sharp. A tool that named a tech giant.
category: stationery
tags: ['stationery', 'school', 'daily-life']
draft: false
...
examples:
  - japanese: シャープペンシルの芯が折れた。
    ...
    translation: My mechanical pencil lead broke.
  - japanese: 試験ではシャーペンを使ってもいいですか。
    reading: しけんでは シャーペンを つかっても いいですか。
    translation: Can I use a mechanical pencil in the exam?
  - japanese: 0.5ミリのシャーペンが一番書きやすい。
    reading: れいてんごミリの シャーペンが いちばん かきやすい。
    translation: A 0.5mm mechanical pencil is the easiest to write with.
animeAppearances:
  - title: Bakuman
    description: Manga artists Moritaka and Takagi use シャープペンシル for storyboards and dialogue drafts, showing the tool's central role in the Japanese manga-production workflow.
  - title: Hyouka
    description: The Classics Club's research scenes are filled with シャーペン scratching on paper as Houtarou and Eru pore over clues and old documents.
