...
jlpt: N3
metaDescription: >-
  Japanese "バックミラー" (bakku mirā) means the mirrors a driver uses to check behind — but English speakers say "rearview mirror" or "side mirror", never "back mirror".
...
examples:
  - japanese: バックミラーで後ろを確認する。
    ...
    translation: I check behind me using the rearview mirror.
  - japanese: バックミラーに大きなトラックが見えた。
    reading: バックミラーに おおきな トラックが みえた。
    translation: I saw a big truck in the rearview mirror.
  - japanese: サイドのバックミラーを調整してください。
    reading: サイドの バックミラーを ちょうせいしてください。
    translation: Please adjust the side mirrors.
animeAppearances:
