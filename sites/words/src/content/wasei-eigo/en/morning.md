...
jlpt: N3
metaDescription: >-
  "Morning" in Japan means a cafe breakfast set — coffee, toast, and egg — not just the time of day. Discover this delicious wasei-eigo and kissaten culture.
category: food
...
examples:
  - japanese: 喫茶店でモーニングを食べよう。
    ...
    translation: Let's go eat a morning set at the coffee shop.
  - japanese: このカフェのモーニングサービスは8時から11時までです。
    reading: この カフェの モーニングサービスは はちじから じゅういちじまでです。
    translation: This cafe's morning service runs from 8 to 11 AM.
  - japanese: 名古屋のモーニングは量がすごい。
    reading: なごやの モーニングは りょうが すごい。
    translation: Nagoya's morning sets are incredibly generous.
animeAppearances:
  - title: Shirokuma Cafe
    description: The laid-back cafe setting of this anime perfectly captures the kissaten atmosphere where モーニング culture thrives. Characters frequently enjoy coffee and light meals in this cozy environment.
  - title: Nichijou
    description: The everyday slice-of-life moments in Nichijou occasionally feature characters visiting cafes and enjoying casual meals — the kind of ordinary routine where モーニング fits right in.
