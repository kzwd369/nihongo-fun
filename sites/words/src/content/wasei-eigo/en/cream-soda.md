...
jlpt: N4
metaDescription: >-
  Japanese "クリームソーダ" (kurīmu sōda) is a bright-green melon soda topped with a scoop of vanilla ice cream — nothing like the brown American cream soda. A Shōwa-retro kissaten icon.
category: food
tags: ['drinks', 'sweets', 'retro']
draft: false
publishedAt: '2026-04-22'
originalEnglish: cream soda
japaneseMeaning: Green melon soda topped with a scoop of vanilla ice cream
englishMeaning: A vanilla-flavored carbonated soft drink
examples:
  - japanese: 喫茶店でクリームソーダを頼んだ。
    reading: きっさてんで クリームソーダを たのんだ。
    translation: I ordered a cream soda at the coffee shop.
  - japanese: クリームソーダの緑色がきれいだね。
    reading: クリームソーダの みどりいろが きれいだね。
    translation: The green color of the cream soda is so pretty.
  - japanese: 昭和レトロな喫茶店でクリームソーダを飲むのが好き。
    reading: しょうわレトロな きっさてんで クリームソーダを のむのが すき。
    translation: I love drinking cream soda at Shōwa-retro coffee shops.
animeAppearances:
  - title: Odd Taxi (オッドタクシー)
    description: The show's downbeat, late-night Tokyo atmosphere leans heavily on kissaten aesthetics, and a classic green クリームソーダ appears as a visual shorthand for the old, fading cafés that the main cast frequents. The glowing emerald glass against dim wooden interiors captures the exact Shōwa nostalgia the series runs on.
  - title: Again!! (また、また君を好きになる)
    description: Scenes set in old-fashioned cafés feature クリームソーダ as the drink of choice for teenage characters, highlighting its status as both a youthful treat and a time-travel prop — a drink that looks and tastes like a decade that won't come back.
