...
jlpt: N3
metaDescription: >-
  Japanese "ライブハウス" (raibu hausu) means a small live music venue — not a "live house." English speakers say "music venue," "club," or "dive bar." Explore the culture of SHELTER, LOFT, and the indie scene.
...
examples:
  - japanese: 今夜、下北沢のライブハウスで友達のバンドを見る。
    ...
    translation: Tonight I'm seeing my friend's band at a live house in Shimokitazawa.
  - japanese: ライブハウスはドリンク代が別途かかる。
    reading: ライブハウスは ドリンクだいが べっと かかる。
    translation: At a live house, there's a separate drink charge.
  - japanese: 彼らは小さなライブハウスから始めて、今では武道館まで来た。
    reading: かれらは ちいさな ライブハウスから はじめて、いまでは ぶどうかんまで きた。
    translation: They started out in tiny live houses, and now they've made it to the Budokan.
animeAppearances:
  - title: BOCCHI THE ROCK! (ぼっち・ざ・ろっく!)
    description: Nearly every episode revolves around STARRY, the fictional Shimokitazawa ライブハウス where Kessoku Band plays. The show lovingly captures the grit, the narrow stairs to the basement, the awkward pre-show setup, and the ritual of selling tickets yourself to fill the room — an almost documentary-accurate portrait of Japan's indie venue scene.
  - title: BECK (ベック)
    description: Koyuki's journey from shy high-schooler to frontman plays out across a string of increasingly larger ライブハウス. The cramped stages, sweaty crowds, and dog-eared flyers are drawn with obvious love, positioning the ライブハウス as the sacred proving ground where Japanese rock dreams either survive or die.
