...
jlpt: N3
metaDescription: >-
  Japanese "バックナンバー" (bakku nanbā) means back issues of a magazine, past podcast episodes, or a sports jersey number. In modern English "back number" is archaic — here's what to say instead.
category: media
...
examples:
  - japanese: この雑誌のバックナンバーを探している。
    ...
    translation: I'm looking for back issues of this magazine.
  - japanese: 彼の背番号、つまりバックナンバーは7番だ。
    reading: かれの せばんごう、つまり バックナンバーは 7ばんだ。
    translation: His sebangō — his jersey number — is 7.
  - japanese: ポッドキャストのバックナンバーを一気に聞いた。
    reading: ポッドキャストの バックナンバーを いっきに きいた。
    translation: I binged the whole podcast archive in one sitting.
animeAppearances:
  - title: Bakuman (バクマン。)
    description: >-
...
**1. Past issues of a magazine or newsletter**
*「この雑誌のバックナンバーを取り寄せた」* — "I ordered back issues of this magazine." This is the original and still most common use. Every bookshop, every publisher's website, every library uses it.

**2. Archived episodes of a show or podcast**
*「そのラジオ番組のバックナンバーはアプリで聴ける」* — "You can listen to the back catalog of that radio show in the app." Radiko, Spotify Japan, and podcast apps all use バックナンバー for their archives.

**3. A sports jersey number**
*「バックナンバー10番を背負う」* — "To wear jersey number 10." Synonymous with **背番号** (sebangō). You hear this constantly in baseball, soccer, and volleyball coverage.
