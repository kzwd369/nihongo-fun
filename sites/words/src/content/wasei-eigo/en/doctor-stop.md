...
jlpt: N2
metaDescription: >-
  Japanese "ドクターストップ" (dokutā sutoppu) means being ordered by a doctor to stop — but native English has no such noun, only phrases like "doctor's orders" or "medical stoppage".
category: daily-life
...
japaneseMeaning: >-
  A doctor's order to stop an activity — work, sports, drinking, smoking, and so on — for health reasons. Used as a noun, often with かかる (to be hit with) or がかかる (to be issued).
englishMeaning: >-
  "Doctor stop" is not a real English noun. Native speakers say "under doctor's orders", "the doctor told me to stop", or for a fight "doctor stoppage" / "medical stoppage". English has no single compact noun that covers the Japanese usage.
examples:
  - japanese: 働きすぎてドクターストップがかかった。
    reading: はたらきすぎて ドクターストップが かかった。
    translation: I overworked myself and my doctor ordered me to stop.
  - japanese: 試合中にドクターストップで中止になった。
    reading: しあいちゅうに ドクターストップで ちゅうしに なった。
    translation: The match was stopped mid-fight on doctor's orders.
  - japanese: 医者からお酒はドクターストップだ。
    reading: いしゃから おさけは ドクターストップだ。
    translation: My doctor has ordered me to stop drinking.
animeAppearances:
