...
jlpt: N3
metaDescription: >-
  El japonés "ノースリーブ" (nōsurību) significa sin mangas. Descubre por qué la moda japonesa acuñó una palabra con "no-" que los angloparlantes nunca usan.
category: fashion
tags: ['moda', 'ropa', 'vida-diaria']
draft: false
...
examples:
  - japanese: 夏はノースリーブの服が楽だ。
    ...
    translation: En verano, la ropa sin mangas es muy cómoda.
  - japanese: ノースリーブのワンピースを買った。
    reading: ノースリーブの ワンピースを かった。
    translation: Me compré un vestido sin mangas.
  - japanese: オフィスではノースリーブは控えたほうがいい。
    reading: オフィスでは ノースリーブは ひかえた ほうが いい。
    translation: En la oficina es mejor evitar la ropa sin mangas.
animeAppearances:
  - title: Fairy Tail
    description: Muchas de las luchadoras del gremio — Erza Scarlet, Lucy, Cana — llevan tops ノースリーブ como ropa de combate habitual, acorde con la estética aventurera de la serie.
  - title: Oregairu (Yahari Ore no Seishun Lovecome wa Machigatteiru)
    description: Los episodios de verano muestran a los compañeros de clase pasándose a atuendos ノースリーブ, convirtiendo un simple cambio de armario en una pista visual estacional con la que la serie marca el paso del tiempo.
