...
jlpt: N4
metaDescription: >-
  El japonés "ハンドル" (handoru) significa volante o manillar, pero en inglés "handle" es un pomo o asa, nunca la rueda que se agarra para conducir un coche.
...
examples:
  - japanese: 彼はハンドルを握るのが好きだ。
    ...
    translation: Le encanta ponerse al volante.
  - japanese: 片手ハンドルは危ない。
    reading: かたて ハンドルは あぶない。
    translation: Conducir con una sola mano es peligroso.
  - japanese: 急ハンドルを切ると危険です。
    reading: きゅうハンドルを きると きけんです。
    translation: Dar un volantazo brusco es peligroso.
animeAppearances:
