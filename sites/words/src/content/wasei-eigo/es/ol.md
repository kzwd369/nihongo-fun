...
jlpt: N3
metaDescription: >-
  "OL" significa "office lady" — un wasei-eigo japonés para las trabajadoras de oficina. Aprende su origen, contexto cultural y su uso cambiante.
category: work
...
examples:
  - japanese: 姉はOLとして銀行で働いています。
    ...
    translation: Mi hermana mayor trabaja en un banco como oficinista.
  - japanese: OL向けのファッション雑誌が人気です。
    reading: オーエルむけの ファッションざっしが にんきです。
    translation: Las revistas de moda para mujeres oficinistas son populares.
  - japanese: OL時代の友達と久しぶりに会った。
    reading: オーエルじだいの ともだちと ひさしぶりに あった。
    translation: Me reuní con amigas de mi época de oficinista después de mucho tiempo.
animeAppearances:
  - title: Aggretsuko
    description: Retsuko es la OL moderna por excelencia — trabaja en el departamento de contabilidad, soporta a un jefe sexista, hace horas extras y libera sus frustraciones cantando death metal en el karaoke. La serie captura perfectamente la vida de una OL en el Japón corporativo.
  - title: Servant × Service
    description: Esta comedia laboral sigue a funcionarios públicos incluyendo a Yamagami Lucy, mostrando la rutina diaria de las trabajadoras de oficina en una oficina gubernamental japonesa con mucho humor sobre la cultura OL.
