...
jlpt: N3
metaDescription: >-
  El japonés "バックミラー" (bakku mirā) designa los espejos que el conductor usa para mirar atrás, pero en inglés se dice "rearview mirror" o "side mirror", nunca "back mirror".
...
examples:
  - japanese: バックミラーで後ろを確認する。
    ...
    translation: Compruebo lo que hay detrás con el retrovisor.
  - japanese: バックミラーに大きなトラックが見えた。
    reading: バックミラーに おおきな トラックが みえた。
    translation: Vi un camión grande por el retrovisor.
  - japanese: サイドのバックミラーを調整してください。
    reading: サイドの バックミラーを ちょうせいしてください。
    translation: Por favor, ajuste los espejos laterales.
animeAppearances:
