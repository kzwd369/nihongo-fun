...
jlpt: N3
metaDescription: >-
  El japonés "ウィンカー" (winkā) significa intermitente del coche, pero los angloparlantes dicen "turn signal" (EE. UU.), "blinker" (EE. UU.) o "indicator" (Reino Unido). "Winker" no es la palabra habitual en inglés.
...
examples:
  - japanese: 右折するのでウィンカーを出した。
    ...
    translation: Puse el intermitente porque iba a girar a la derecha.
  - japanese: ウィンカーを出さずに曲がるのは違反だ。
    reading: ウィンカーを ださずに まがるのは いはんだ。
    translation: Girar sin poner el intermitente es una infracción.
  - japanese: ウィンカーが点かない。
    reading: ウィンカーが つかない。
    translation: El intermitente no se enciende.
animeAppearances:
