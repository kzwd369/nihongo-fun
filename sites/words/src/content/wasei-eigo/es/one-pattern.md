...
jlpt: N2
metaDescription: >-
  El japonés "ワンパターン" (wan patān) no significa nada en inglés — "one pattern" no es una expresión. Los angloparlantes dicen "predictable", "formulaic", "cookie-cutter" o "a one-trick pony".
category: slang
tags: ['argot', 'expresión', 'comportamiento']
draft: false
...
examples:
  - japanese: 彼のギャグはワンパターンだ。
    ...
    translation: Sus chistes son súper previsibles — siempre el mismo esquema.
  - japanese: 最近のトレンディドラマはワンパターンすぎる。
    reading: さいきんの トレンディ ドラマは ワンパターン すぎる。
    translation: Los dramas trendy de última hora son demasiado formulaicos.
  - japanese: デートがワンパターンで彼女に飽きられた。
    reading: デートが ワンパターンで かのじょに あきられた。
    translation: Mis citas eran tan clónicas que mi novia se aburrió de mí.
animeAppearances:
