...
jlpt: N3
metaDescription: >-
  El japonés "キーホルダー" (kī horudā) no es un perchero de pared para llaves — es lo que en inglés se llama "key chain" o "key ring": el colgante decorativo atado a las llaves. Te explicamos por qué el merchandising de Akihabara confunde a los angloparlantes.
category: fashion
tags: ['moda', 'merchandising', 'anime', 'accesorios']
draft: false
...
examples:
  - japanese: アニメショップで可愛いキーホルダーを買った。
    ...
    translation: Me compré un llavero mono en la tienda de anime.
  - japanese: お土産に温泉のキーホルダーをもらった。
    reading: おみやげに おんせんの キーホルダーを もらった。
    translation: Me regalaron un llavero de recuerdo de un onsen.
  - japanese: 推しのアクリルキーホルダーを集めている。
    reading: おしの アクリル キーホルダーを あつめている。
    translation: Colecciono charms acrílicos de mi oshi.
animeAppearances:
