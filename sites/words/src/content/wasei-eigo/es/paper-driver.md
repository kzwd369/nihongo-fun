...
jlpt: N2
metaDescription: >-
  "Paper driver" es un wasei-eigo que describe a alguien con licencia de conducir que nunca conduce. Aprende por qué es tan común en Japón.
category: daily-life
tags: ['vida cotidiana', 'conducción', 'cultura']
draft: false
...
examples:
  - japanese: ペーパードライバーなので運転が怖いです。
    ...
    translation: Como soy un conductor de papel, me da miedo conducir.
  - japanese: ペーパードライバー講習を受けてみようかな。
    reading: ペーパードライバー こうしゅうを うけてみようかな。
    translation: Quizás debería tomar un curso de repaso de conducción.
  - japanese: 免許は持っているけど、完全にペーパードライバーです。
    reading: めんきょは もっているけど、かんぜんに ペーパードライバーです。
    translation: Tengo licencia, pero soy un conductor de papel total.
animeAppearances:
  - title: Laid-Back Camp (ゆるキャン△)
    description: Los personajes a menudo dependen de otros para que los lleven a los lugares de acampada. La dificultad de no sentirse cómodo al volante es un tema muy identificable para muchos jóvenes japoneses.
  - title: Mi vecino Totoro
    description: El padre lleva a la familia al campo en coche, pero en el Japón moderno, muchos habitantes de la ciudad se identifican más con la idea de no necesitar un coche — convirtiéndolos en clásicos "paper drivers."
