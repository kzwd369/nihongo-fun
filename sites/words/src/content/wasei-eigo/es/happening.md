...
jlpt: N3
metaDescription: >-
  El japonés "ハプニング" (hapuningu) no significa un "happening" neutro — significa un percance cómico, un accidente o una metedura de pata en directo. Por eso tu historia de boda confunde a los angloparlantes.
category: general
tags: ['argot', 'medios', 'tv']
draft: false
...
examples:
  - japanese: 結婚式でちょっとしたハプニングがあった。
    ...
    translation: Hubo un pequeño percance en la boda.
  - japanese: 生放送中のハプニング映像が話題になっている。
    reading: なまほうそうちゅうの ハプニング えいぞうが わだいに なっている。
    translation: Las imágenes del patinazo en directo se están haciendo virales.
  - japanese: 旅行先でハプニング続きで大変だった。
    reading: りょこうさきで ハプニングつづきで たいへんだった。
    translation: En el viaje fue un desastre tras otro — un auténtico caos.
animeAppearances:
  - title: Ranma ½ (らんま1/2)
    description: Toda la serie funciona a base de ハプニング. Agua fría cae sobre Ranma y se transforma en chica, alguien entra en el peor momento posible, aparece una prometida de la nada — Takahashi Rumiko construyó básicamente 38 tomos de manga con ハプニング perfectamente cronometrados al estilo japonés, de esos en los que todos se quedan congelados y una gota de sudor aparece en la frente.
  - title: La melancolía de Haruhi Suzumiya (涼宮ハルヒの憂鬱)
    description: El universo de Haruhi es un generador de ハプニング por diseño — reescribe la realidad inconscientemente cuando se aburre, así que el pobre Kyon se pasa la serie lidiando con bucles temporales, encuentros alienígenas y festivales escolares descontrolados. Cada capítulo es esencialmente una cadena de ハプニング de alto riesgo que Kyon tiene que arreglar en silencio.
