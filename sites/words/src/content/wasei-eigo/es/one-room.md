...
jlpt: N4
metaDescription: >-
  El japonés "ワンルーム" (wan rūmu) significa un estudio (apartamento), no una habitación cualquiera. Descubre el sistema japonés de planos y por qué "one-room" no es inglés real.
category: housing
tags: ['vivienda', 'inmobiliario', 'vida-diaria']
draft: false
...
examples:
  - japanese: 大学の近くのワンルームに住んでいる。
    ...
    translation: Vivo en un estudio cerca de la universidad.
  - japanese: 東京のワンルームは家賃が高い。
    reading: とうきょうの ワンルームは やちんが たかい。
    translation: Los estudios en Tokio tienen un alquiler alto.
  - japanese: 一人暮らしを始めたのでワンルームを借りた。
    reading: ひとりぐらしを はじめたので ワンルームを かりた。
    translation: Empecé a vivir solo, así que alquilé un estudio.
animeAppearances:
  - title: Tokyo Magnitude 8.0 (東京マグニチュード8.0)
    description: La vida familiar de Mirai y las escenas de refugiados tras el terremoto contrastan con el estilo de vida apretado de los solteros tokiotas en su ワンルーム, dando una imagen realista de cuán compacta es la vida urbana en la capital.
  - title: Honey and Clover (ハチミツとクローバー)
    description: El grupo de amigos de la escuela de arte se pasa el día metidos en los diminutos apartamentos ワンルーム unos de otros, un escenario que define el ambiente bohemio y joven adulto de la serie.
