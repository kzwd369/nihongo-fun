...
jlpt: N3
metaDescription: >-
  El japonés "クラクション" (kurakushon) significa claxon del coche, pero en inglés "klaxon" suele referirse a sirenas de alarma en barcos o fábricas, no al claxon de tu coche.
...
examples:
  - japanese: クラクションを鳴らして注意を促した。
    ...
    translation: Toqué el claxon para avisar.
  - japanese: 後ろの車がクラクションを鳴らした。
    reading: うしろの くるまが クラクションを ならした。
    translation: El coche de atrás tocó el claxon.
  - japanese: 住宅街でクラクションを鳴らしてはいけない。
    reading: じゅうたくがいで クラクションを ならしては いけない。
    translation: No se debe tocar el claxon en zonas residenciales.
animeAppearances:
