...
romaji: arubaito
jlpt: N4
metaDescription: '"Arubaito" en japonés significa trabajo de medio tiempo, pero no viene del inglés — viene del alemán "Arbeit" (trabajo). Aprende la historia de este wasei-eigo.'
category: work
tags: ['trabajo', 'vida-diaria', 'vida-estudiantil']
draft: false
...
examples:
  - japanese: 来月から新しいアルバイトを始めます。
    ...
    translation: Voy a empezar un nuevo trabajo de medio tiempo el próximo mes.
  - japanese: コンビニでアルバイトをしています。
    reading: コンビニで アルバイトを しています。
    translation: Trabajo de medio tiempo en una tienda de conveniencia.
  - japanese: 大学生のとき、週三回バイトしていました。
    reading: だいがくせいの とき、しゅうさんかい バイトしていました。
    translation: Cuando era estudiante universitario, trabajaba medio tiempo tres veces por semana.
animeAppearances:
  - title: The Devil is a Part-Timer! (はたらく魔王さま！)
    description: Toda la premisa gira en torno a un rey demonio que consigue un trabajo de medio tiempo (アルバイト) en un restaurante de comida rápida. La palabra aparece constantemente en la serie.
  - title: Barakamon (ばらかもん)
    description: Los personajes en la isla rural discuten sobre el trabajo de medio tiempo y アルバイト, reflejando la cultura laboral cotidiana que contrasta con la carrera artística del protagonista.
