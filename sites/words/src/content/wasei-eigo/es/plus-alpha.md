...
jlpt: N2
metaDescription: >-
  El japonés "プラスアルファ" (purasu arufa) significa "más un extra" — pero el inglés nativo nunca dice "plus alpha". Los equivalentes son "plus bonuses", "above and beyond" o "the X factor".
category: business
tags: ['negocios', 'modismo', 'matemáticas']
draft: false
...
examples:
  - japanese: 月給25万円プラスアルファで募集しています。
    ...
    translation: Contratamos con 250.000 yenes al mes, más extras encima.
  - japanese: 基本料金プラスアルファで延長料金が発生します。
    reading: きほん りょうきん プラスアルファで えんちょう りょうきんが はっせい します。
    translation: Hay una tarifa base, más un recargo adicional por prolongación.
  - japanese: 合格するにはプラスアルファの努力が必要だ。
    reading: ごうかく するには プラスアルファの どりょくが ひつようだ。
    translation: Para aprobar hace falta ese esfuerzo extra por encima del habitual.
animeAppearances:
