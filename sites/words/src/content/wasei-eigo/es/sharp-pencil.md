...
jlpt: N4
metaDescription: >-
  El japonés "シャープペンシル" (shāpu penshiru) significa portaminas — y es el motivo por el que Sharp Corporation se llama Sharp. Una herramienta que bautizó a un gigante tecnológico.
category: stationery
tags: ['papelería', 'escuela', 'vida-diaria']
draft: false
...
examples:
  - japanese: シャープペンシルの芯が折れた。
    ...
    translation: Se me partió la mina del portaminas.
  - japanese: 試験ではシャーペンを使ってもいいですか。
    reading: しけんでは シャーペンを つかっても いいですか。
    translation: ¿Puedo usar un portaminas en el examen?
  - japanese: 0.5ミリのシャーペンが一番書きやすい。
    reading: れいてんごミリの シャーペンが いちばん かきやすい。
    translation: Un portaminas de 0,5 mm es con el que mejor se escribe.
animeAppearances:
  - title: Bakuman
    description: Los mangakas Moritaka y Takagi usan シャープペンシル para los storyboards y borradores de diálogos, mostrando el papel central de esta herramienta en el flujo de producción del manga japonés.
  - title: Hyouka
    description: Las escenas de investigación del Club de Literatura Clásica están llenas del roce del シャーペン sobre el papel mientras Hōtarō y Eru repasan pistas y documentos antiguos.
