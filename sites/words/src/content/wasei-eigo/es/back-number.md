...
jlpt: N3
metaDescription: >-
  El japonés "バックナンバー" (bakku nanbā) significa números atrasados de una revista, episodios pasados de un podcast o el dorsal de una camiseta deportiva. En inglés moderno "back number" suena anticuado — aquí tienes lo que se dice realmente.
category: media
tags: ['medios', 'revista', 'deportes']
draft: false
...
examples:
  - japanese: この雑誌のバックナンバーを探している。
    ...
    translation: Estoy buscando números atrasados de esta revista.
  - japanese: 彼の背番号、つまりバックナンバーは7番だ。
    reading: かれの せばんごう、つまり バックナンバーは 7ばんだ。
    translation: Su sebangō — o sea, su dorsal — es el 7.
  - japanese: ポッドキャストのバックナンバーを一気に聞いた。
    reading: ポッドキャストの バックナンバーを いっきに きいた。
    translation: Me metí todo el archivo del podcast del tirón.
animeAppearances:
  - title: Bakuman (バクマン。)
    description: >-
...
**1. Números atrasados de una revista o boletín**
*「この雑誌のバックナンバーを取り寄せた」* — "Pedí números atrasados de esta revista." Es el uso original y sigue siendo el más común. Cada librería, cada web editorial y cada biblioteca lo usa.

**2. Episodios archivados de un programa o podcast**
*「そのラジオ番組のバックナンバーはアプリで聴ける」* — "Puedes escuchar el archivo de ese programa de radio en la app." Radiko, Spotify Japan y las apps de podcast usan バックナンバー para sus archivos.

**3. El dorsal de una camiseta deportiva**
*「バックナンバー10番を背負う」* — "Llevar el dorsal número 10." Sinónimo de **背番号** (sebangō). Se oye constantemente en retransmisiones de béisbol, fútbol y voleibol.
