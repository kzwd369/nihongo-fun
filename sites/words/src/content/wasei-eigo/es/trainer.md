...
jlpt: N4
metaDescription: >-
  El japonés "トレーナー" (torēnā) es una sudadera, no unas zapatillas ni un entrenador. Descubre cómo "trainer" pasó de ropa deportiva a básico del armario.
category: fashion
...
examples:
  - japanese: 寒くなってきたのでトレーナーを着た。
    ...
    translation: Como empezaba a hacer frío, me puse una sudadera.
  - japanese: このグレーのトレーナー、気に入ってる。
    reading: この グレーの トレーナー、きに いってる。
    translation: Me encanta esta sudadera gris.
  - japanese: 寒い日はトレーナーの上にパーカーを重ねる。
    reading: さむい ひは トレーナーの うえに パーカーを かさねる。
    translation: En los días fríos, me pongo una sudadera con capucha sobre la sudadera normal.
animeAppearances:
  - title: Haikyuu!!
    description: Las escenas fuera de la cancha muestran al club de voleibol de Karasuno con トレーナー informales como ropa cotidiana cuando no están de uniforme, reflejando la moda real de los estudiantes japoneses.
  - title: Himouto! Umaru-chan
    description: La persona casera icónica de Umaru se activa cuando se pone una トレーナー con capucha — la serie convierte la prenda en un atajo visual para su identidad "en casa".
