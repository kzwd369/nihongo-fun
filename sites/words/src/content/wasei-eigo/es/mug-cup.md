...
jlpt: N5
metaDescription: >-
  El japonés "マグカップ" (magu kappu) es simplemente una "mug" — pero decir "mug cup" en inglés suena redundante y raro. Te contamos por qué el japonés añade カップ y el inglés no.
category: home
tags: ['hogar', 'vajilla', 'cotidiano']
draft: false
...
examples:
  - japanese: 新しいマグカップを買った。
    ...
    translation: Me compré una taza nueva.
  - japanese: 朝はマグカップでコーヒーを飲む。
    reading: あさは マグカップで コーヒーを のむ。
    translation: Por la mañana tomo el café en マグカップ.
  - japanese: このマグカップは電子レンジで使えます。
    reading: この マグカップは でんしレンジで つかえます。
    translation: Esta マグカップ se puede meter al microondas.
animeAppearances:
  - title: Natsume's Book of Friends (夏目友人帳)
    description: Las noches tranquilas en casa de los Fujiwara casi siempre muestran a Natsume sosteniendo una マグカップ caliente, con el té humeando entre sus manos mientras habla con Nyanko-sensei. La taza se convierte en el símbolo visual de la seguridad y calidez que nunca tuvo de niño.
  - title: Non Non Biyori (のんのんびより)
    description: Las escenas acogedoras después del colegio en casa de Renge dependen mucho de la imagen de la マグカップ — chocolate caliente, kotatsu de invierno, una taza demasiado grande entre manos pequeñas. Todo el mood del anime condensado en un objeto de cerámica.
