...
jlpt: N2
metaDescription: >-
  El japonés "バージンロード" (bājin rōdo) es el pasillo por el que entra la novia en una boda al estilo occidental — pero en inglés se dice "aisle", nunca "virgin road". Te contamos por qué la traducción literal suena rarísima.
category: wedding
tags: ['boda', 'ceremonia', 'nupcial']
draft: false
...
examples:
  - japanese: 父と一緒にバージンロードを歩いた。
    ...
    translation: Recorrí el pasillo de la mano de mi padre.
  - japanese: バージンロードの長さは約7メートルです。
    reading: バージンロードの ながさは やく 7メートル です。
    translation: El pasillo mide unos 7 metros.
  - japanese: 花嫁がゆっくりバージンロードを進む。
    reading: はなよめが ゆっくり バージンロードを すすむ。
    translation: La novia avanza lentamente por el pasillo.
animeAppearances:
