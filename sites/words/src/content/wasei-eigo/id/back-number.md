...
jlpt: N3
metaDescription: >-
  "バックナンバー" (bakku nanbā) dalam bahasa Jepang berarti edisi lama majalah, episode podcast lama, atau nomor jersey olahraga. Dalam bahasa Inggris modern "back number" arkais — inilah yang harus dikatakan.
category: media
tags: ['media', 'magazine', 'sports']
draft: false
...
examples:
  - japanese: この雑誌のバックナンバーを探している。
    ...
    translation: Saya sedang mencari edisi lama majalah ini.
  - japanese: 彼の背番号、つまりバックナンバーは7番だ。
    reading: かれの せばんごう、つまり バックナンバーは 7ばんだ。
    translation: Sebangō-nya — yakni nomor jerseynya — adalah 7.
  - japanese: ポッドキャストのバックナンバーを一気に聞いた。
    reading: ポッドキャストの バックナンバーを いっきに きいた。
    translation: Saya menyantap seluruh arsip podcast sekaligus.
animeAppearances:
  - title: Bakuman (バクマン。)
    description: >-
...
**1. Edisi lama majalah atau newsletter**
*「この雑誌のバックナンバーを取り寄せた」* — "Saya memesan edisi lama majalah ini." Ini penggunaan asli dan masih paling umum. Setiap toko buku, setiap situs web penerbit, setiap perpustakaan menggunakannya.

**2. Episode arsip acara atau podcast**
*「そのラジオ番組のバックナンバーはアプリで聴ける」* — "Anda bisa mendengarkan katalog lama acara radio itu di aplikasinya." Radiko, Spotify Jepang, dan aplikasi podcast semuanya menggunakan バックナンバー untuk arsipnya.

**3. Nomor jersey olahraga**
*「バックナンバー10番を背負う」* — "Memakai jersey nomor 10." Sinonim dengan **背番号** (sebangō). Anda terus mendengarnya dalam liputan bisbol, sepak bola, dan voli.
