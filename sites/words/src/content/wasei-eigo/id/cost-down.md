...
jlpt: N3
metaDescription: >-
  "コストダウン" (kosuto daun) dalam bahasa Jepang berarti pengurangan biaya — tetapi penutur bahasa Inggris asli mengatakan "cost cutting" atau "reduce costs", tidak pernah "cost down" sebagai kata benda.
category: business
tags: ['business', 'work', 'manufacturing']
draft: false
...
examples:
  - japanese: 工場のコストダウンを進めている。
    ...
    translation: Kami sedang mengerjakan pengurangan biaya di pabrik.
  - japanese: 部品を変えてコストダウンに成功した。
    reading: ぶひんを かえて コストダウンに せいこうした。
    translation: Kami mengganti suku cadang dan berhasil memangkas biaya.
  - japanese: 品質を下げずにコストダウンするのは難しい。
    reading: ひんしつを さげずに コストダウンするのは むずかしい。
    translation: Memangkas biaya tanpa menurunkan kualitas itu sulit.
animeAppearances:
  - title: Shin Godzilla (シン・ゴジラ)
    description: Adegan rapat pemerintah terus-menerus memanggil コストダウン saat birokrat memperdebatkan kendala anggaran respons darurat. Film ini dengan penuh kasih memparodikan jargon kementerian Jepang yang sebenarnya, dan kata itu mendarat sebagai tic birokratis sekaligus humor gelap.
  - title: Aggretsuko (アグレッシブ烈子)
    description: Kantor akuntansi Retsuko terus-menerus di bawah tekanan untuk コストダウン dari manajemen atas. Tuntutan tanpa henti untuk memeras anggaran persis seperti gerinda korporat yang memicu katarsis karaoke death-metal setelah jam kerjanya.
