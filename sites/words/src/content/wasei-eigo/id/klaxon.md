...
jlpt: N3
metaDescription: >-
  "クラクション" (kurakushon) dalam bahasa Jepang berarti klakson mobil — tetapi dalam bahasa Inggris "klaxon" biasanya merujuk pada sirene peringatan keras di kapal atau pabrik, bukan klakson di mobil Anda.
...
examples:
  - japanese: クラクションを鳴らして注意を促した。
    ...
    translation: Saya membunyikan klakson untuk memperingatkan mereka.
  - japanese: 後ろの車がクラクションを鳴らした。
    reading: うしろの くるまが クラクションを ならした。
    translation: Mobil di belakang saya membunyikan klaksonnya.
  - japanese: 住宅街でクラクションを鳴らしてはいけない。
    reading: じゅうたくがいで クラクションを ならしては いけない。
    translation: Anda tidak boleh membunyikan klakson di area perumahan.
animeAppearances:
