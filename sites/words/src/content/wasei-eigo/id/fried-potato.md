...
jlpt: N4
metaDescription: >-
  "フライドポテト" (furaido poteto) dalam bahasa Jepang berarti kentang goreng (French fries). Pelajari mengapa Jepang menciptakan namanya sendiri yang harfiah untuk camilan yang dikenal dunia ini.
category: food
...
examples:
  - japanese: マックでフライドポテトのLサイズを頼んだ。
    ...
    translation: Saya memesan kentang goreng ukuran besar di McDonald's.
  - japanese: ビールにはフライドポテトがよく合う。
    reading: ビールには フライドポテトが よく あう。
    translation: Kentang goreng sangat cocok dengan bir.
  - japanese: 子供たちはフライドポテトが大好きだ。
    reading: こどもたちは フライドポテトが だいすきだ。
    translation: Anak-anak sangat suka kentang goreng.
animeAppearances:
  - title: K-On! (Keion!)
    description: Klub musik ringan sering berbagi sepiring フライドポテト di sesi restoran keluarga setelah latihan, momen camilan remaja Jepang yang khas.
  - title: Crayon Shin-chan
    description: Obsesi Shinnosuke dengan makanan cepat saji berarti フライドポテト muncul terus-menerus dalam perjalanan keluarga ke rantai bergaya McDonald's.
