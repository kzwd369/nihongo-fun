...
jlpt: N3
metaDescription: >-
  "バックミラー" (bakku mirā) dalam bahasa Jepang berarti kaca spion yang digunakan pengemudi untuk mengecek belakang — tapi penutur bahasa Inggris mengatakan "rearview mirror" atau "side mirror", tidak pernah "back mirror".
...
examples:
  - japanese: バックミラーで後ろを確認する。
    ...
    translation: Saya mengecek belakang menggunakan kaca spion.
  - japanese: バックミラーに大きなトラックが見えた。
    reading: バックミラーに おおきな トラックが みえた。
    translation: Saya melihat truk besar di kaca spion.
  - japanese: サイドのバックミラーを調整してください。
    reading: サイドの バックミラーを ちょうせいしてください。
    translation: Tolong sesuaikan kaca spion samping.
animeAppearances:
