...
jlpt: N4
metaDescription: >-
  "ハンドル" (handoru) dalam bahasa Jepang berarti roda kemudi atau handlebar — tetapi dalam bahasa Inggris "handle" adalah pegangan pintu atau kata kerja, bukan benda yang Anda genggam untuk menyetir mobil.
...
examples:
  - japanese: 彼はハンドルを握るのが好きだ。
    ...
    translation: Dia suka berada di balik kemudi.
  - japanese: 片手ハンドルは危ない。
    reading: かたて ハンドルは あぶない。
    translation: Menyetir dengan satu tangan itu berbahaya.
  - japanese: 急ハンドルを切ると危険です。
    reading: きゅうハンドルを きると きけんです。
    translation: Membanting setir tiba-tiba itu berbahaya.
animeAppearances:
